...
<table border='0' style="width:795px;background-color:#E6E6E6;margin:0px;margin-top:0px;padding:0px;">
	...
	<td rowspan='2' style="width:450px;">
	    <img src="images/ptvolleyballplay.png" alt="Playtagger Logo" id="vidpop" style="border:none;border-top-right-radius:0px;border-top-left-radius:0px;border-bottom-right-radius:0px;border-bottom-left-radius:0px;">
    ...
    <tr>
        <td style="vertical-align:top;padding-top:10px;padding-left:10px;padding-right:25px;font-family:sans-serif;font-size:15px;">
            <span style="color:#FF8E04;font-weight:bold;">PlayTagger</span> is your hassle-free, online highlight reel.
            <br><br>
            ...
            <br><br>
            No matter where you want to go, <span style="color:#FF8E04;font-weight:bold;">PlayTagger</span> is the fastest, easiest way to be seen!
        </td>
    </tr>
    <tr>
