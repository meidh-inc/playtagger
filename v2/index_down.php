...
if (isset($_POST['login'])) { // The user clicked 'login'
    ...
    // no errors detected so far, continue
		...
		if (mysql_num_rows($result_login) == 1) {  // Success
		    ...
		    //Get Sport ID
			//this is where I'd set the sportID
...
<div style="width:725px;font-family: sans-serif;">
    ...
    <div class="ui-corner-all" style="background-color:#000000;padding:5px;padding-top: 10px;height:35px;text-align: center;">
	<span style="color:white;font-family:sans-serif;font-size:24px;font-weight:bold;text-decoration: underline;">
	    Version 2.0 is arriving soon.  Please check back in an hour.
	</span>
	<!--
