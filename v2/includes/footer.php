...
<div id="footer" style="font-size:10px;padding-left:0px;margin-top:10px;">
	<center>
		...
		<?php
			echo "PlayTagger: ". $sportName;
			//check to see if they are an admin
			$allowed_users = array(1, 4, 5, 12, 30, 42);
			// 1 = eric-localhost
			// 4 = eric-live
			// 5 = chris-live-iahsra account
			// 12 = Brandi-live
			// 30 = chris-live-meidh account
		...
		<?php
			...
			// 42 = John O'brien-live
			if(in_array($userid,$allowed_users)){
			    echo " | <a href=\"admin.php\" style=\"outline:none;background:none;border:none;color:black;font-size:10px;\">Admin</a>";
			}
