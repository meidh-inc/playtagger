...
function loadVideo(videoID) {  // Loads the selected video into the player.
    if(ytplayer) {
    ...
    document.getElementById("hiddenVid").value = videoID;
}
