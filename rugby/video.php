...
<div id="dialog-tag" title="Tag">
    ...
    echo "</select></div>"; ?></td>
	    ...
	    <tr>
                ...
                <td style="text-align:left;padding:5px;"><select id="whatHappened"><option value="Pick Item">Pick Item</option><option value="Score">Score</option><option value="Assist">Assist</option><option value="Tackle">Tackle</option><option value="Nice Run">Nice Run</option><option value="Won Possession">Won Possession</option><option value="Kick">Kick</option></select></td>
            </tr>
	    <tr>
